                        ...
                        <div>
                            <span style="width:60%; text-align:left;  display: inline-block;">
                              ...
                              <div class="checkbox-container">
                                <input class="" name="lembrarMe" type="checkbox" v-model="user.lembrarMe" id="lembrarMe">
...
.form-check-input:checked {
  background-color: #25b4b9; /* Cor de fundo quando o checkbox está selecionado */
  border-color: #25b4b9; /* Cor da borda quando o checkbox está selecionado */
}
